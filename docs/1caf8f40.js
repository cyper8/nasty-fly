import{R as t,i as e,t as i,b as s,e as n,s as o,r,o as a,$ as c}from"./c7bd9f05.js";
/*! *****************************************************************************
 ...
 */const M=n(class extends x{constructor(t){if(super(t),t.type!==i.CHILD)throw Error("asyncAppend can only be used in child expressions")}update(t,e){return this._$CX=t,super.update(t,e)}commitValue(t,e){0===e&&(t=>{t._$AR()})(this._$CX);const i=((t,e,i)=>{var s;const n=t._$AA.parentNode,o=void 0===e?t._$AB:e._$AA;if(void 0===i){const e=n.insertBefore(f(),o),s=n.insertBefore(f(),o);i=new p(e,s,t,t.options)}else{const e=i._$AB.nextSibling,r=i._$AM,a=r!==t;if(a){let e;null===(s=i._$AQ)||void 0===s||s.call(i,t),i._$AM=t,void 0!==i._$AP&&(e=t._$AU)!==r._$AU&&i._$AP(e)}if(e!==o||a){let t=i._$AA;for(;t!==e;){const e=t.nextSibling;n.insertBefore(t,o),t=e}}}return i})(this._$CX);((t,e,i=t)=>{t._$AI(e,i)})(i,t)}}),k=new URL(new URL("4619654e.svg",import.meta.url).href,import.meta.url).href,z=new URL(new URL("f6cb2ad3.svg",import.meta.url).href,import.meta.url).href,P=new URL(new URL("a773a733.mp3",import.meta.url).href,import.meta.url).href;class U extends o{constructor(){super(),this.стан="сидить",this.__liveliness=5,this.__buzz=new Audio(P),this.__x=0,this.__y=0,this.__кут=Math.random()*(2*Math.PI),this.__CANBUZZ=!1,this.__buzz.addEventListener("canplaythrough",(()=>{this.__CANBUZZ=!0,this.dispatchEvent(new CustomEvent("readytofly",{bubbles:!1,composed:!0}))})),this.__x=Math.round(Math.random()*window.innerWidth),this.__y=Math.round(Math.random()*window.innerHeight),this.addEventListener("click",(t=>{const e=t.target;e&&("сидить"===e.стан?e.літатиПротягом(1+Math.random()*(this.liveliness/2)):"літає"===e.стан&&e.вмерти())}))}set liveliness(t){let e=t;t>10&&(e=10),t<0&&(e=0),this.__liveliness=e}get liveliness(){return this.__liveliness}static get styles(){return r`
    ...
    `}"_зліт"(){return this.стан="літає",this.__CANBUZZ&&this.__buzz.play(),new Promise((t=>{this.__затримкаЗльоту=window.setTimeout((()=>{clearTimeout(this.__затримкаЗльоту),this.dispatchEvent(new CustomEvent("літає",{bubbles:!0,composed:!0})),t()}),100+Math.random()*(90-3*this.liveliness))}))}"__рухатисяДо"(t){let e=this.shadowRoot.querySelector("div.муха");const[i,s]=[e.offsetLeft,e.offsetTop],[n,o]=t,r=Math.atan((o-s)/(n-i))+(n>=i?1:-1)*Math.PI/2;return e=this,window.requestAnimationFrame((()=>{e.__кут=r,e.__x=n,e.__y=o})),t}get"__випадковеМісцеПопереду"(){const t=["sin","cos"],e=Math.random(),i=1-e;const s=this.__кут+(e*Math.PI/4-Math.PI/8);return[this.__x,this.__y].map(((e,n)=>{const o=(U.БАЗОВИЙ_КРОК+3*this.liveliness)*(1+Math.random()+i)*((n?-1:1)*Math[t[n]](s)+function(t,e,i){const s=[window.innerWidth,window.innerHeight];return t<i?(i-t)/i:t>s[e]-i?(s[e]-i-t)/i:0}(e,n,U.БАЗОВИЙ_ПОРІГ));return e+o}))}"літатиПротягом"(t){const e=Date.now()+Math.round(1e3*t),i=this;let s;return i._зліт().then((()=>new Promise((t=>{s=window.setInterval((()=>{Date.now()<e&&"літає"===i.стан?i.__рухатисяДо(i.__випадковеМісцеПопереду):(clearInterval(s),"літає"===i.стан&&i._сісти(),t())}),10)}))))}"_сісти"(){this.стан="сидить",this.__buzz.pause(),this.dispatchEvent(new CustomEvent("сидить",{bubbles:!0,composed:!0}))}"вмерти"(){this.стан="прибита",this.__buzz.pause(),this.dispatchEvent(new CustomEvent("смерть",{bubbles:!0,composed:!0}))}render(){return c`
      <div
        class="муха"
        style="left: ${this.__x}px; top: ${this.__y}px; transform: rotateZ(${this.__кут}rad) translate(-50%,-50%) scale(1);"
        is=${this.стан}
      ></div>
    `}}U.БАЗОВИЙ_КРОК=20,U.БАЗОВИЙ_ПОРІГ=95,h([d({type:String})],U.prototype,"стан",void 0),h([d({type:Number})],U.prototype,"liveliness",null),h([u()],U.prototype,"__buzz",void 0),h([u()],U.prototype,"__x",void 0),h([u()],U.prototype,"__y",void 0),h([u()],U.prototype,"__кут",void 0),h([u()],U.prototype,"__затримкаЗльоту",void 0),h([u()],U.prototype,"__CANBUZZ",void 0),window.customElements.define("nasty-fly",U);class E extends o{constructor(){super(...arguments),this.counter=0,this.maxcount=50,this.мухи=this.щемухи()}async*"щемухи"(){for(;this.counter<this.maxcount;){let t=c``;const e=new Promise((e=>{t=c`
          <nasty-fly
            liveliness=${this.counter}
            @смерть=${()=>setTimeout(e,4e3*Math.random())}
          ></nasty-fly>
        `}));yield t,await e,this.counter+=1}}render(){return c`
  ...
  `,h([d({type:Number})],E.prototype,"counter",void 0),h([d({type:Number})],E.prototype,"maxcount",void 0),window.customElements.define("nasty-fly-game",E);
